...
public class SimpleDrop implements ConfigurationSerializable {
    ...
    public SimpleDrop(ItemInfo itemInfo, int minAmount, int amount, double chance, boolean announce) {
    ...
    public SimpleDrop(String itemID, int minAmount, int maxAmount, double chance, boolean announce){
        this(ItemsManager.getInstance().getItemByID(itemID), minAmount, maxAmount, chance, announce);
    }

    public SimpleDrop(String itemID, int amount, double chance, boolean announce){
    ...
    public static SimpleDrop deserialize(Map<String, Object> map){
        ...
        return new SimpleDrop(itemID, minAmount, maxAmount, chance, announce);
    }
}
